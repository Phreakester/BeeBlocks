...
function Street(props) {
    ...
    return(
        <div className='main-street'>
            ...
            <Hoverable src={red_triangle} className='hover-market' setCurrentText={setCurrentText} text={market_text} defaultText={default_text} />
            <Hoverable src={red_triangle} className='hover-shade' setCurrentText={setCurrentText} text={shade_text} defaultText={default_text} />
